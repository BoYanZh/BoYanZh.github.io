...
\section{Experience}
  ...
  \resumeSubHeader
    ...
    \resumeItemListStart
      \resumeItem{Developed and implemented an \textbf{LLVM pass plugin} and related tools to conduct advanced fuzz testing on communication protocols such as USB and Bluetooth for ARM32 embedded devices.}
    \resumeItemListEnd
  \resumeSubHeader
