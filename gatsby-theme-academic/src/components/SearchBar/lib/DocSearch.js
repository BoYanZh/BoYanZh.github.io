 ...
 * value.
 * @param  {Object} [options.autocompleteOptions] Options to pass to the
 * underlying autocomplete instance
 * @return {Object}
 */
class DocSearch {
  constructor({
  ...
  static bindSearchBoxEvent() {
    ...
    $('input#docsearch').on('keyup', () => {
      const searchbox = window.document.querySelector('input#docsearch');
      const reset = window.document.querySelector('.searchbox [type="reset"]');
